...
class Calendar 
{
    ...
    public function getCalendar($month = false,$year = false) {
    ...
    public static function format12To24($hours , $minutes, $type) 
    {
        $minutes = sprintf("%02d", $minutes);
        $hours = sprintf("%02d", $hours);
        $time = date("H:i:s", strtotime ("$hours:$minutes $type")); 
        return $time;
    }
    ...
    public static function format24ToTstamp($time)
    {
